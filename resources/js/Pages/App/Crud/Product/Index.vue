...
<template>
    ...
    <div class="flex items-center justify-between">
        ...
        <button @click="addProduct" class="px-4 py-2 mt-4 text-sm font-semibold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">
            Agregar Producto
        </button>
    </div>
</template>
